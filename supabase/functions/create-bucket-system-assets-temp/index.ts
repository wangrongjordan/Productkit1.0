...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/jpeg", "image/png", "image/gif", "image/webp", "image/svg+xml"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Upload for system-assets" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'system-assets');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for system-assets" ON storage.objects FOR UPDATE USING (bucket_id = 'system-assets');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for system-assets" ON storage.objects FOR DELETE USING (bucket_id = 'system-assets');`
    ];
